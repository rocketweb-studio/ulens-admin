import { CustomTable, IconBlock, Input, Select } from '@rocketweb-studio/ulens-ui-kit'
...
export const UserList = () => {
  ...
  return (
    <div>
      ...
      <CustomTable
        data={rowsTableUsers || ([] as User[])}
        columns={columnsTable}
        paginated
        currentPage={page}
        elementCount={data?.getUsers.totalCount || 0}
      ...
      {/*  elementCount={data?.getUsers.totalCount || 0}*/}
      {/*  onPageChange={(e) => paginationHandler(e.page)}*/}
      {/*/>*/}
      <UserBan
