...
export type GetUsersQuery = { __typename?: 'Query', getUsers: { __typename?: 'UsersResponse', page: number, pageSize: number, totalCount: number, items: Array<{ __typename?: 'UserModel', id: string, userName?: string | null, isBlocked: boolean, createdAt: string }> } };
...
export type GetUsersQuery = { __typename?: 'Query', getUsers: { __typename?: 'UsersResponse', page: number, pageSize: number, totalCount: number, items: Array<{ __typename?: 'UserModel', id: string, userName?: string | null, createdAt: string, isBlocked: boolean }> } };
